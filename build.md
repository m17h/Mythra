...
4. build the .app
5. sign it with the installed Developer ID certificate and notarize it using a credential stored securely in Keychain or supplied at release time; never commit the credential
