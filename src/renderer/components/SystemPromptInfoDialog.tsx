          ...
          >
            ...
            <div className="app-dialog__section">
              ...
              <p>
                ...
                versions per <strong>provider</strong> (LM Studio or OpenRouter). Switch presets when you change projects
                or want a different baseline without rewriting everything—<strong>Save as new…</strong> is an easy way to
